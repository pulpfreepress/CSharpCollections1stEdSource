...
public class EmployeeTrainingClient : Form {
  ...
  private void InitializeComponent(){
    ...
    ToolStripMenuItem exitMenuItem = new ToolStripMenuItem("Exit", null, new EventHandler(this.ExitProgramHandler));
    
    ToolStripMenuItem createMenu = new ToolStripMenuItem("Create");
    ToolStripMenuItem employeeMenuItem = new ToolStripMenuItem("Employee...", null,  new EventHandler(this.CreateEmployeeHandler));
    ToolStripMenuItem trainingMenuItem = new ToolStripMenuItem("Training...", null, new EventHandler(this.CreateTrainingHandler));
  ...
  *************************************************************/
  ...
  private void EmployeeGridClickedHandler(Object sender, EventArgs e){
    ...
    _trainingGrid.DataSource = _employeeTraining.GetTrainingForEmployee(_employeeList[selected_row].EmployeeID);
  }
