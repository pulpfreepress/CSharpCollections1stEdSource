...
public class EmployeeTrainingServer : Form  {
  ...
  private void InitializeComponent(){
    ...
    _flowpanel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
    ...
    _gender_groupbox.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
    ...
    _employee_info_entry_panel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
   ...
   _training_info_entry_panel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
   ...
   _tablepanel.Width =  _training_textbox.Width + _employee_info_entry_panel.Width + LARGE_PADDING;
  ...
  private void AdjustAppWindowSize(){
    ...
    _training_textbox.Width = TRAINING_TEXTBOX_WIDTH;
    _training_textbox.Height = TRAINING_TEXTBOX_HEIGHT;
    _tablepanel.Width = (_picturebox.Width + _flowpanel.Width + _employee_info_entry_panel.Width + SMALL_PADDING);
    _tablepanel.Height = (_picturebox.Image.Height + _training_textbox.Height + SMALL_PADDING);
