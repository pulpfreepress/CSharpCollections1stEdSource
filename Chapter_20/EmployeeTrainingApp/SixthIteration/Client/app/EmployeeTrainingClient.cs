...
public class EmployeeTrainingClient : Form {
  ...
  *************************************************************/
  ...
  private void EmployeeGridClickedHandler(Object sender, EventArgs e){
    ...
    _trainingList = _employeeTraining.GetTrainingForEmployee(_employeeList[selected_row].EmployeeID);
    _trainingGrid.DataSource = _trainingList;
  ...
  private void EmployeeGridDataBindingCompleteHandler(Object sender, EventArgs e){
  ...
  private void TrainingGridDataBindingCompleteHandler(Object sender, EventArgs e){
  ...
  private void DeleteTrainingHandler(Object sender, EventArgs e){
     ...
     if(result == DialogResult.OK){
       ...
       _trainingList = _employeeTraining.GetTrainingForEmployee(_employeeList[selected_employee].EmployeeID);
       _trainingGrid.DataSource = _trainingList;
       if(_trainingList.Count > 0){
         _trainingGrid.Rows[0].Selected = true;
         _editTrainingMenuItem.Enabled = true;
