...
public class MonitorLockTakenDemo {
   ...
   public static void Main(){
     MonitorLockTakenDemo mltd = new MonitorLockTakenDemo();
     Thread t1 = new Thread(mltd.InserterMethod);
     Thread t2 = new Thread(mltd.ReaderMethod);
